...
if (!is_dir($product_folder)) {
    ...
    $sql = "INSERT INTO categories (product_name, product_stock, product_weight, product_desc, product_price, product_date, product_images) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    $stmt->bind_param("sisssss", $product_name, $product_stock, $product_weight, $product_desc, $product_price, $current_date, $image_paths_string);
    $stmt->execute();
    $stmt->close();
